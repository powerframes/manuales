...
|**Tipo de consulta:** Coordenada puntual con longitud y latitud dentro de Colombia| **Estampa de tiempo del evento:** Estampa del evento ingresada por el usuario|
...
||
|-|
|**Coordenadas del punto ingresado:** Es el punto de longitud y latitud en el que está situada la subestación consultada|
...
## Tabla de descargas
En esta tabla de muestran todas las descargas de la coordenada específica consultada que tengan un SCORE superior a 0.600. Cada una de las descargas cuenta con la siguiente información:
...
![Figura 87](../../../pictures/Imagen87.png "Actividad eléctrica atmosférica")
...
**Figura 58.** *Actividad eléctrica atmosférica*
 ...
 4. <img src="../../../pictures/Imagen88.png" alt="Figura 88" width="100"> La ubicación de la coordenada puntual consultada
 5. 
    |||
    |-|-|
...
En esta gráfica de burbujas se muestran los datos corresponientes a la magnitud de corriente de las descargas (representado en el diámetro de la burbuja), la cercanía en distancia a la coordenada especificada (eje Y) y en cercanía en tiempo a la estampa de tiempo de la falla (eje X), sobre la gráfica hay una línea roja que representa la estapa de tiempo ingresada en la consulta.
