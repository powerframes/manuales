...
La plataforma está configurado por defecto para que el usuario visualice el mapa de colombia con la información de **"Tiempo Real"**, el mapa se va a mostrar centrad y sin ningún filtro temporal, ni espacial como se muestra en [Figura 7](../../../pictures/Imagen7.png).

![Figura 7](../../../pictures/Imagen7.png "Modulo de supervisión")
**Figura 7.** *Modulo de supervisión*
